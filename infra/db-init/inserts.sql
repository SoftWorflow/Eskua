...
call createUser('admin_master', 'admin@example.com', 'Administrador General', 'https://picsum.photos/200?1', 
'$argon2id$v=19$m=65536,t=4,p=1$N1VEd2YuS2ZHdE1kZmJ3ag$7XzBwLCR7BACHwa9NzdThxGgrlA42c9V9zqdACejKc4', 
'Admin'); -- password: admin123

call createUser('juan123', 'juan@example.com', 'Juan Pérez', 'https://picsum.photos/200?2', 
'$argon2id$v=19$m=65536,t=4,p=1$Mk9zeEg5YUJhSEpleS9IaA$EaTJX3mRP8L8XAIZaCkEdMlUgYcP0ScxTBhuSqWs968', 
'Teacher'); -- password: juan123

call createUser('maria.l', 'maria@example.com', 'María López', 'https://picsum.photos/200?3', 
...
call createUser('sofia99', 'sofia@example.com', 'Sofía Ramírez', 'https://picsum.photos/200?4', 
...
call createUser('carlos_t', 'carlos@example.com', 'Carlos Torres', 'https://picsum.photos/200?5', 
...
call createUser('guest_01', 'guest01@example.com', 'Invitado Uno', 'https://picsum.photos/200?6', 
'$argon2id$v=19$m=65536,t=4,p=1$ZXFlenN6NjBNLzhYRkhLOA$2Q+Li0DERL7Oqf8e0CgpTFYHWCf3SUArJgloW1IuLB0', 
'Guest'); -- password: guest123

call createUser('lucia_m', 'lucia@example.com', 'Lucía Méndez', 'https://picsum.photos/200?7', 
'$argon2id$v=19$m=65536,t=4,p=1$TEFOMkRTOEdtRWJmUU5aag$/eg+9leZZRdha8hbJAE42+1OCFpqjzKahuVsCmDUE/k', 
'Student'); -- password: lucia123

call createUser('pedro_g', 'pedro@example.com', 'Pedro González', 'https://picsum.photos/200?8', 
...
call createUser('ana_s', 'ana@example.com', 'Ana Suárez', 'https://picsum.photos/200?9', 
'$argon2id$v=19$m=65536,t=4,p=1$RC9laXFEcEtEVWt4UU1zdA$rwd/F/UjjVR+nzqTiVDHjYzk821dGkIlBzE3lIUFm08', 
'Student'); -- password: ana123

call createUser('martin_dev', 'martin@example.com', 'Martín Díaz', 'https://picsum.photos/200?10', 
